...
I'm based in Italy and I like making practical, slightly chaotic projects: local tools, static sites, experiments, and whatever sounds fun enough to build on a Saturday evening.

Right now I mostly play with:
...
| --- | --- | --- |
| [JuanLab](https://github.com/Gianni0177/JuanLab) | Personal GitHub Pages site with pages for Spyral Abyss, Imaginarium Theater, Stygian Onslaught, and current character guides. | JavaScript, CSS, HTML |
| [Local-format-converter](https://github.com/Gianni0177/Local-format-converter) | Simple multi-format converter, still evolving. | Python |
| [bmi-studio](https://github.com/Gianni0177/bmi-studio) | A Saturday evening thingy that became a repo. | JavaScript |
| [Batch-project](https://github.com/Gianni0177/Batch-project) | Scripts and automation experiments. | PowerShell |
